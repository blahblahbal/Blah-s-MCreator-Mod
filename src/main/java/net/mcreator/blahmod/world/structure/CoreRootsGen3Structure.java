...
public class CoreRootsGen3Structure extends BlahmodModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public CoreRootsGen3Structure(BlahmodModElements instance) {
		super(instance, 1560);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("core_roots_gen_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:core_roots_gen_3"), configuredFeature);
		}
	}
	@SubscribeEvent
