...
public class CGST29Structure extends BlahmodModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public CGST29Structure(BlahmodModElements instance) {
		super(instance, 1524);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cgst_29"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:cgst_29"), configuredFeature);
		}
	}
	@SubscribeEvent
