...
public class CoreGroveLargeTree2Structure extends BlahmodModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public CoreGroveLargeTree2Structure(BlahmodModElements instance) {
		super(instance, 1470);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("core_grove_large_tree_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:core_grove_large_tree_2"), configuredFeature);
		}
	}
	@SubscribeEvent
