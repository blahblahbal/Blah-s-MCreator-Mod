...
public class CoreRoots11Structure extends BlahmodModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public CoreRoots11Structure(BlahmodModElements instance) {
		super(instance, 1719);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new Feature<NoFeatureConfig>(NoFeatureConfig.field_236558_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					if (!dimensionCriteria)
						return false;
					if ((random.nextInt(10000) + 1) <= 10000) {
			...
			event.getRegistry().register(feature.setRegistryName("core_roots_11"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:core_roots_11"), configuredFeature);
		}
	}
	@SubscribeEvent
