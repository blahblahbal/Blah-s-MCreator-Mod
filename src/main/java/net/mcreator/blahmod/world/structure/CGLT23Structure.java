...
public class CGLT23Structure extends BlahmodModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public CGLT23Structure(BlahmodModElements instance) {
		super(instance, 1528);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cglt_23"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:cglt_23"), configuredFeature);
		}
	}
	@SubscribeEvent
