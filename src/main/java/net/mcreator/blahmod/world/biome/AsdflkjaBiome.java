...
public class AsdflkjaBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public AsdflkjaBiome(BlahmodModElements instance) {
		super(instance, 1769);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:asdflkja"));
			}
		}
	}
	@Override
