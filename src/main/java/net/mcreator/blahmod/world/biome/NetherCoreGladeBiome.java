...
public class NetherCoreGladeBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public NetherCoreGladeBiome(BlahmodModElements instance) {
		super(instance, 1767);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:nether_core_glade"));
			}
		}
	}
	@Override
