...
import net.mcreator.blahmod.entity.DarkMatterSlimeEntity;
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(DarkMatterSlimeEntity.entity, 5, 1, 1));
